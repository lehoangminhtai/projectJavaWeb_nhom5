			...
			<div class="col-md-3">
				<div class="card">
					<div class="card-body">
						...
						<a href="post/add?userid=${userEntry.value}" class="card-link">Thêm bài viết mới</a><br>
					</div>
						...
						<div class="card gedf-card">
							...
							<c:forEach var="likeCount" items="${likeCount}">
								<c:if test="${post.postid == likeCount.key}">
									<%-- <a href="/posts/post/${post.postid}/${userid}/like" class="card-link1"><i class="fa fa-gittip"></i>
									${likeCount.value} Like</a> --%>
