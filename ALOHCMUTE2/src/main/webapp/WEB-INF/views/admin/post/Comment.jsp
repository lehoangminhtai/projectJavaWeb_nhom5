...
<body class="bg-light">
    <div class=" container col-md-10 gedf-main mx-auto " id="commentsSection">
        <div class="container mt-5 ">
            ...
            <div class="row">
                <div class="">
                    <form id="LoadCmt" action="<c:url value='/posts/post/cmtSave'/>" method="post">
                        <input type="hidden" name="postid" value="${post.postid}">
                        <input type="hidden" name="userid" value="${userid}">
                        <div class="form-group d-flex align-items-center">
                            <input type="text" class="form-control" id="idcontent" name="content"
                                placeholder="Nhập bình luận" required value="${cmtModel.content}">
